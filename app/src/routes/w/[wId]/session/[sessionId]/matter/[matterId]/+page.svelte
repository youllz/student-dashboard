<script lang="ts">
	...
	const { form, enhance } = superForm(data.addNoteForm, {
...
<section>
			...
			>
				...
				<svelte:fragment slot="cell" let:row let:cell>
					{#if cell.key === 'rule' && cell.value === 'Round robin'}
						<Link icon={Launch} href="https://en.wikipedia.org/wiki/Round-robin_DNS" target="_blank"
							>{cell.value}</Link
						>
					{:else}
						{cell.value}
	...
	<div class="chart-container">
		<div class="chart-container-header">
			<h1>Satistic</h1>
			<div>
				<Select labelText="Chart" selected="g10" on:change={(e) => console.log('value', e)}>
